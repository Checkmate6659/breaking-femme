...
public class AndrostadienedioneOilSolutionCauldronBlock extends AbstractCauldronBlock {
    ...
    static {
        CauldronBehavior FILL = (state, world, pos, player, hand, stack) -> {
            return CauldronBehavior.fillCauldron(world, pos, player, hand, stack, ModFluids.ANDROSTADIENEDIONE_OIL_SOLUTION_CAULDRON.getDefaultState(), SoundEvents.ITEM_BUCKET_EMPTY);
        };
