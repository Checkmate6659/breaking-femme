...
public class ModItems {
    ...
    public static final Item CHILI_PEPPER = registerItem("chili_pepper", new ChiliPepperItem(new FabricItemSettings().food(new FoodComponent.Builder().hunger(6).saturationModifier(4f).alwaysEdible().build())));
