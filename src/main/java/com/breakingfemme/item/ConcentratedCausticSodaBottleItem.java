...
public class ConcentratedCausticSodaBottleItem extends Item {
    public ConcentratedCausticSodaBottleItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        //need to damage (and very likely kill) player AFTER stack has been "consumed", otherwise... problems.
        //TODO: a "what were you thinking" achievement
