...
public class BreakingFemmeClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        WorldRenderEvents.AFTER_TRANSLUCENT.register(context -> {
            ...
            passes.get(3).getProgram().getUniformByNameOrDummy("Timer").set((player.getWorld().getTime() % 65536 + context.tickDelta()) / 65536f); //repeats almost every (real) hour
            passes.get(3).getProgram().getUniformByNameOrDummy("Rotation").set(0.0f); //up to 1 is good
            passes.get(3).getProgram().getUniformByNameOrDummy("Saturation").set(0.0f); //0.5 is quite good
            passes.get(3).getProgram().getUniformByNameOrDummy("WarpStrength").set(0.0f); //0.0625 is quite good
        ...
        FluidRenderHandlerRegistry.INSTANCE.register(ModFluids.STILL_SPILLAGE, ModFluids.FLOWING_SPILLAGE,
            new SimpleFluidRenderHandler(
                new Identifier("minecraft:block/water_still"),
                new Identifier("minecraft:block/water_flow"),
                0xFFFFFFFF)
        );
        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(), ModFluids.STILL_SPILLAGE, ModFluids.FLOWING_SPILLAGE);

        FluidRenderHandlerRegistry.INSTANCE.register(ModFluids.STILL_ESTRONE_OIL_SOLUTION, ModFluids.FLOWING_ESTRONE_OIL_SOLUTION,
            new SimpleFluidRenderHandler(
                new Identifier("minecraft:block/water_still"),
                new Identifier("minecraft:block/water_flow"),
                0xC0EEEE67)
        );
        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(), ModFluids.STILL_ESTRONE_OIL_SOLUTION, ModFluids.FLOWING_ESTRONE_OIL_SOLUTION);
        ColorProviderRegistry.BLOCK.register((blockState, blockAndTintGetter, blockPos, i) -> {
            if (i == 0)
                return 0xC0EEEE67;
            return -1;
        }, ModFluids.ESTRONE_OIL_SOLUTION_CAULDRON);

        FluidRenderHandlerRegistry.INSTANCE.register(ModFluids.STILL_LYE_WATER, ModFluids.FLOWING_LYE_WATER,
            new SimpleFluidRenderHandler(
                new Identifier("minecraft:block/water_still"),
                new Identifier("minecraft:block/water_flow"),
                0xE042240E)
        );
        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(), ModFluids.STILL_LYE_WATER, ModFluids.FLOWING_LYE_WATER);
        ColorProviderRegistry.BLOCK.register((blockState, blockAndTintGetter, blockPos, i) -> {
            if (i == 0)
                return 0xE042240E;
            return -1;
        }, ModFluids.LYE_WATER_CAULDRON);

        FluidRenderHandlerRegistry.INSTANCE.register(ModFluids.STILL_CAUSTIC_SODA_SOLUTION, ModFluids.FLOWING_CAUSTIC_SODA_SOLUTION,
            new SimpleFluidRenderHandler(
                new Identifier("minecraft:block/water_still"),
                new Identifier("minecraft:block/water_flow"),
                0xC0D0E0F0)
        );
        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(), ModFluids.STILL_CAUSTIC_SODA_SOLUTION, ModFluids.FLOWING_CAUSTIC_SODA_SOLUTION);
        ColorProviderRegistry.BLOCK.register((blockState, blockAndTintGetter, blockPos, i) -> {
            if (i == 0)
                return 0xC0D0E0F0;
            return -1;
        ...
        FluidRenderHandlerRegistry.INSTANCE.register(ModFluids.STILL_CONCENTRATED_CAUSTIC_SODA, ModFluids.FLOWING_CONCENTRATED_CAUSTIC_SODA,
            new SimpleFluidRenderHandler(
                new Identifier("minecraft:block/water_still"),
                new Identifier("minecraft:block/water_flow"),
                0xEEDCE8F3)
        );
        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(), ModFluids.STILL_CONCENTRATED_CAUSTIC_SODA, ModFluids.FLOWING_CONCENTRATED_CAUSTIC_SODA);
        ColorProviderRegistry.BLOCK.register((blockState, blockAndTintGetter, blockPos, i) -> {
            if (i == 0)
                return 0xEEDCE8F3;
            return -1;
        ...
        FluidRenderHandlerRegistry.INSTANCE.register(ModFluids.STILL_HYDROCHLORIC_ACID, ModFluids.FLOWING_HYDROCHLORIC_ACID,
            new SimpleFluidRenderHandler(
                new Identifier("minecraft:block/water_still"),
                new Identifier("minecraft:block/water_flow"),
                0xC0CC8877)
        );
        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(), ModFluids.STILL_HYDROCHLORIC_ACID, ModFluids.FLOWING_HYDROCHLORIC_ACID);
        ColorProviderRegistry.BLOCK.register((blockState, blockAndTintGetter, blockPos, i) -> {
            if (i == 0)
                return 0xC0CC8877;
            return -1;
        }, ModFluids.HYDROCHLORIC_ACID_CAULDRON);

        FluidRenderHandlerRegistry.INSTANCE.register(ModFluids.STILL_KELP_ASH_MUD, ModFluids.FLOWING_KELP_ASH_MUD,
            new SimpleFluidRenderHandler(
                new Identifier("minecraft:block/water_still"),
                new Identifier("minecraft:block/water_flow"),
                0x2E2E2E2E)
        );
        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(), ModFluids.STILL_KELP_ASH_MUD, ModFluids.FLOWING_KELP_ASH_MUD);
        ColorProviderRegistry.BLOCK.register((blockState, blockAndTintGetter, blockPos, i) -> {
            if (i == 0)
                return 0x2E2E2E2E;
            return -1;
        }, ModFluids.KELP_ASH_MUD_CAULDRON);
