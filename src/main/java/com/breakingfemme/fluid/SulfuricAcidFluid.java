...
public abstract class SulfuricAcidFluid extends FlowableFluid {
    ...
    {
        return ModFluids.STILL_SULFURIC_ACID;
    }
    ...
    {
        return ModFluids.SULFURIC_ACID_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state)
    {
        return ModFluids.SULFURIC_ACID_FLUID_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
