...
public abstract class HydrochloricAcidFluid extends FlowableFluid {
    ...
    {
        return ModFluids.STILL_HYDROCHLORIC_ACID;
    }
    ...
    {
        return ModFluids.HYDROCHLORIC_ACID_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state)
    {
        return ModFluids.HYDROCHLORIC_ACID_FLUID_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
