...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        CookingRecipeJsonBuilder.createSmelting(Ingredient.fromTag(ModItemTagProvider.PULVERIZED_IRON), RecipeCategory.MISC, Items.IRON_INGOT, 0, 200).criterion(hasItem(ModItems.PULVERIZED_IRON), conditionsFromTag(ModItemTagProvider.PULVERIZED_IRON)).offerTo(exporter, "iron_ingot_from_remelting");
        CookingRecipeJsonBuilder.createBlasting(Ingredient.fromTag(ModItemTagProvider.PULVERIZED_IRON), RecipeCategory.MISC, Items.IRON_INGOT, 0, 100).criterion(hasItem(ModItems.PULVERIZED_IRON), conditionsFromTag(ModItemTagProvider.PULVERIZED_IRON)).offerTo(exporter, "iron_ingot_from_remelting_blasting");
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModBlocks.FERMENTER_BOTTOM.asItem(), 4).input('#', ItemTags.PLANKS).input('-', ModItemTagProvider.IRON_INGOT).pattern("###").pattern(" - ").group("fermenter_top").criterion(hasItem(Items.IRON_INGOT), conditionsFromItem(Items.IRON_INGOT)).offerTo(exporter);
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModBlocks.FERMENTER_CONTROLLER.asItem()).input('w', Items.REDSTONE).input('^', Items.IRON_INGOT).input('-', Items.CHEST).input('O', ModBlocks.FERMENTER_PANEL).pattern("OwO").pattern("^-^").pattern("OwO").group("fermenter_controller").criterion(hasItem(Items.MAGMA_BLOCK), conditionsFromItem(Items.MAGMA_BLOCK)).offerTo(exporter);
