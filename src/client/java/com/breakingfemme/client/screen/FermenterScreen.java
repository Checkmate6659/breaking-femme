package com.breakingfemme.client.screen;
...
public class FermenterScreen extends HandledScreen<com.breakingfemme.screen.FermenterScreenHandler> {
    private static final Identifier TEXTURE = id("textures/gui/fermenter.png");

    public FermenterScreen(com.breakingfemme.screen.FermenterScreenHandler handler, PlayerInventory inventory, Text title) {
