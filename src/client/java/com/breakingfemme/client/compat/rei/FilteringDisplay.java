...
import static com.breakingfemme.ModTags.Fluid.HARSH_ON_FILTERS;
import static com.breakingfemme.ModTags.Item.FILTER;
import static com.breakingfemme.ModTags.Item.RESISTANT_FILTER;
...
public class FilteringDisplay extends BasicDisplay {
    ...
    public FilteringDisplay(List<EntryIngredient> inputs, List<EntryIngredient> outputs, Optional<Identifier> identifier)
    {
        ...
        try{ //yeah this is kinda fucked up as well
            ...
            harsh_future = influid.getValue().getFluid().isIn(HARSH_ON_FILTERS);
    ...
    public FilteringDisplay(FilteringRecipe recipe)
    {
        ...
        super(List.of(
            ...
            EntryIngredients.ofItemTag(
                    recipe.input.getFluid().isIn(HARSH_ON_FILTERS) ?
                            RESISTANT_FILTER :
                            FILTER
                )
        ), List.of(
        ...
        harsh = recipe.input.getFluid().isIn(HARSH_ON_FILTERS);
