...
public class FilteringCategory implements DisplayCategory<BasicDisplay> {
    public static final Identifier TEXTURE = id("textures/gui/filtering.png");
    public static final Identifier WARNING_TEXTURE = id("textures/gui/filtering_warning.png");
    public static final Identifier COVER_TEXTURE = id("textures/gui/filtering_output_cover.png");
    public static final CategoryIdentifier<GrindingDisplay> FILTERING = CategoryIdentifier.of(id("filtering"));
